...
* **ci:** let a cancelled run cancel the Gate instead of failing it ([bd67a66](https://github.com/kirchDev/workflows/commit/bd67a666f1b5b0ae95be917dddcac6fac362c761))
